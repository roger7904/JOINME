    ...
    private void setListeners()
    {
        user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(chatting.this, informationedit.class);
        ...
        homepage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(chatting.this, homepage.class);
                startActivity(intent);
            }
        });
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(chatting.this, MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        activitypage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(chatting.this, allactivity.class);
                startActivity(intent);
            }
        });
        ...
        selfpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(chatting.this, selfpage.class);
                startActivity(intent);
            }
        });
        ...
        chatroom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(chatting.this, chatroom.class);
                startActivity(intent);
            }
        });
        ...
        friendpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(chatting.this, friend.class);
                startActivity(intent);
            }
        });
        ...
        favorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(chatting.this, favorite.class);
                startActivity(intent);
            }
        });
        ...
        jo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(chatting.this, jo.class);
                startActivity(intent);
            }
        });
        ...
        notice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(chatting.this, notice.class);
                startActivity(intent);
            }
        });
        ...
        setting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(chatting.this, setting.class);
                startActivity(intent);
            }
        });

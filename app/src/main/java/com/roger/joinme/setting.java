    ...
    private void setListeners()
    {
        user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(setting.this, informationedit.class);
        ...
        activitypage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(setting.this, allactivity.class);
                startActivity(intent);
            }
        });
        ...
        selfpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(setting.this, selfpage.class);
                startActivity(intent);
            }
        });
        ...
        chatroom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(setting.this, chatroom.class);
                startActivity(intent);
            }
        });
        ...
        friendpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(setting.this, friend.class);
                startActivity(intent);
            }
        });
        ...
        favorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(setting.this, favorite.class);
                startActivity(intent);
            }
        });
        ...
        jo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(setting.this, jo.class);
                startActivity(intent);
            }
        });
        ...
        notice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(setting.this, notice.class);
                startActivity(intent);
            }
        });
